...
static const struct fmt_field_def bqueues_fields[] = {
    ...
    {"DESCRIPTION", "DESC", "DESCRIPTION", 50},
    {"PRIORITY", "PRIO", "PRIORITY", 10},
    {"STATUS", "STAT", "STATUS", 12},
    {"MAX", NULL, "MAX", 10},
    {"JL_U", "JLU", "JL/U", 10},
    {"JL_P", "JLP", "JL/P", 10},
    {"JL_H", "JLH", "JL/H", 10},
    ...
    {"MAX_CORELIMIT", "CORELIMIT", "MAX_CORELIMIT", 8},
    {"MAX_CPULIMIT", "CPULIMIT", "MAX_CPULIMIT", 30},
    {"DEFAULT_CPULIMIT", "DEF_CPULIMIT", "DEFAULT_CPULIMIT", 30},
    {"MAX_DATALIMIT", "DATALIMIT", "MAX_DATALIMIT", 8},
    {"DEFAULT_DATALIMIT", "DEF_DATALIMIT", "DEFAULT_DATALIMIT", 8},
    {"MAX_FILELIMIT", "FILELIMIT", "MAX_FILELIMIT", 8},
    {"MAX_MEMLIMIT", "MEMLIMIT", "MAX_MEMLIMIT", 8},
    {"DEFAULT_MEMLIMIT", "DEF_MEMLIMIT", "DEFAULT_MEMLIMIT", 8},
    {"MAX_PROCESSLIMIT", "PROCESSLIMIT", "MAX_PROCESSLIMIT", 8},
    {"DEFAULT_PROCESSLIMIT", "DEF_PROCESSLIMIT", "DEFAULT_PROCESSLIMIT", 8},
    {"MAX_STACKLIMIT", "STACKLIMIT", "MAX_STACKLIMIT", 8},
    {"MAX_SWAPLIMIT", "SWAPLIMIT", "MAX_SWAPLIMIT", 8},
    {"MAX_TASKLIMIT", "TASKLIMIT", "MAX_TASKLIMIT", 6},
    {"MIN_TASKLIMIT", NULL, "MIN_TASKLIMIT", 6},
    {"DEFAULT_TASKLIMIT", "DEF_TASKLIMIT", "DEFAULT_TASKLIMIT", 6}
};
